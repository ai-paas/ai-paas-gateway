...
app.include_router(any_cloud.router_obs, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_workflow, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_admin_cluster, prefix=settings.API_V1_STR)
...
app.include_router(any_cloud.router_node, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_events, prefix=settings.API_V1_STR)
app.include_router(any_cloud.router_shell, prefix=settings.API_V1_STR)
